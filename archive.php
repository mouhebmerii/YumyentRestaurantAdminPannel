...
<div style="margin-left: 10px; margin-right: 10px;" ng-app="liveApp" ng-controller="liveController" ng-init="fetchData()">
    <br />
    <h3 align="center">Archive Pannel</h3><br />
    ...
    <div class="table-responsive" >
        ...
        <script type="text/ng-template" id="display">
            ...
            <button type="button" class="btn btn-danger btn-xm" ng-click="cancel(data.id)">Delete it</button>
            </td>
...
app.controller('liveController', function($scope, $http){
    $scope.fetchData = function(){
        $http.get('arch.php').success(function(data){
