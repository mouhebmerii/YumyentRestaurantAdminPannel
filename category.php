    ...
    <div class="table-responsive" >
        ...
        <form name="testform" ng-submit="insertData()">
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                <tr>
                <td><input type="text" ng-model="addData.id" class="form-control" placeholder="Enter Id" ng-required="true" /></td>
                <td><input type="text" ng-model="addData.title" class="form-control" placeholder="Enter Name for the new category" ng-required="true" /></td>
...
app.controller('liveController', function($scope, $http){
    $scope.fetchData = function(){
        $http.get('select_cat.php').success(function(data){
